...
### [Societal Data Insights Initiative (SDII) Integrated Societal-data Platform for Interdisciplinary Research and Evaluation (InSPIRE) (NOAA OAR WPO)](https://github.com/NOAA-OAR-WPO-SDII)

The [Societal Data Insights Initiative (SDII) Integrated Societal-data Platform for Interdisciplinary Research and Evaluation (InSPIRE) Project](https://sites.google.com/noaa.gov/wpo-social-science/sdii/inspire) is a OneNOAA Initiative, led by [WPO](https://wpo.noaa.gov/). It is a robust data platform designed to support critical evaluation by serving as the foundation for integrating, analyzing, storing, and managing data. The goal is to develop a social science data infrastructure that will significantly enhance NOAA’s capabilities to integrate and synthesize social and meteorological data. The project endeavors to facilitate collaboration and provide user insights to evaluate societal responses to products and services. This GitHub organization serves as a container for repositories that are produced by members and users of the SDII InSPIRE project. 
